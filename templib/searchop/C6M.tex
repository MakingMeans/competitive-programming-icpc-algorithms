\subsection{Búsqueda Binaria sobre la Respuesta con Ventana de Bonificación}
...
\graybold{¿Para qué sirve?} Resolver problemas de "maximizar el mínimo" cuando la modificación disponible tiene una forma estructurada (aquí, un refuerzo en forma de escalera), buscando binariamente el mejor valor objetivo y verificando factibilidad con una condición cerrada en \bigO{n} por candidato.
...
\graybold{I/O:} N ≤ 10\textsuperscript{5} → lectura total con tokenización (patrón 2). Verificado contra fuerza bruta en 300 casos aleatorios pequeños.

\subsection{Kuhn sobre Segmentos de Fila/Columna (torres con peones)}
\label{alg:4-2}
...
\graybold{Complejidad:} \bigO{N^2} para etiquetar segmentos, más \bigO{V \cdot E} para el emparejamiento (V, E acotados por N²).

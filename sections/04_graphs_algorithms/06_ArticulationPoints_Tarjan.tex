...
\graybold{Complejidad:} O(V + E) con DFS iterativo (un solo recorrido con low-link).
...
\graybold{I/O:} Múltiples casos con centinela "0 0" (patrón 3 de la sección de E/S). n ≤ 10\textasciicircum{}4, m ≤ 10\textasciicircum{}5 → lectura total + tokenización, y DFS iterativo con pila explícita (mismo motivo que en Kosaraju: evitar RecursionError/stack overflow).

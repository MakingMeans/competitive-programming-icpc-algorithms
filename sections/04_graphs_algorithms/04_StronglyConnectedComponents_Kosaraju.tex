...
\graybold{Complejidad:} O(V + E) tiempo y espacio (dos recorridos DFS).
...
\graybold{I/O:} n ≤ 10\textasciicircum{}5 y m ≤ 2·10\textasciicircum{}5 → lectura total + tokenización (patrón 2). Además, el DFS se implementa de forma iterativa (con pila explícita) para evitar RecursionError en Python con grafos grandes.

...
Dado un grafo dirigido de $n$ ciudades y $m$ vuelos con longitud, calcular la distancia mínima desde la ciudad 1 a cada ciudad (se garantiza que todas son alcanzables).

...
\graybold{Complejidad:} \bigO{M \alpha(N)} para procesar $M$ aristas sobre $N$ nodos, donde $\alpha$ es la inversa de la función de Ackermann (menor que 5 para cualquier entrada imaginable), es decir prácticamente \bigO{M} amortizado con compresión de caminos.

...
Dado un laberinto de $n \times m$ con paredes, un inicio A y un destino B, decidir si existe un camino moviéndose en las cuatro direcciones y, si existe, imprimir su longitud mínima y los movimientos.

...
\graybold{Complejidad:} O(n) - cada persona se encola y desencola una sola vez.
...
\graybold{I/O:} n ≤ 10\textasciicircum{}4 → lectura total + tokenización (patrón 2); se usan dos deques (collections.deque) en vez de queue, ya que en Python deque tiene O(1) real para popleft().

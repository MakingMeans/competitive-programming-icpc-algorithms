...
\graybold{Utilidad:} Simplificar recorridos o secuencias eliminando ciclos innecesarios. Cada vez que un elemento vuelve a aparecer, todo el recorrido intermedio deja de ser útil y puede eliminarse. Después de cada eliminación es necesario volver a comprobar si ahora se formó un nuevo ciclo con los elementos restantes. Este patrón aparece en problemas de rutas, navegación, directorios, historial de movimientos y simplificación de secuencias.

\subsection{Normalización y Verificación de Palíndromos}
...
\graybold{¿Para qué sirve?} Resolver directamente problemas de verificación de palíndromos con reglas de normalización, filtrando primero y comparando el resultado contra su versión invertida.

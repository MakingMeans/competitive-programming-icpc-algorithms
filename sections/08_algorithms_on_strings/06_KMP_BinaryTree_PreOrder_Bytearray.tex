\subsection{Comparación de Subárboles Ignorando Etiquetas (Codificación en Preorden + KMP)}
...
\graybold{¿Para qué sirve?} Reduce un problema de comparación estructural de árboles (¿este subárbol tiene la misma forma que aquel otro?) a un problema clásico de coincidencia de patrones en cadenas. Es aplicable a cualquier familia de árboles binarios completos donde solo interesa la forma (posición y arity de los nodos), no las etiquetas: sirve tanto para árboles de expresión como para cualquier otra estructura jerárquica que se pueda serializar de la misma manera.

...
Simplificar un recorrido eliminando los rodeos: un sitio repetido dos veces seguidas
sobra, y una ida y vuelta inmediata (\texttt{a!b!a}) se reduce a \texttt{a}. Lo importante es que al quitar un rodeo puede aparecer
...
las aristas deben formar un solo componente conexo y todos los nodos deben tener
grado par.
...
cantidad combina dos paridades: la de la permutación de las piezas y la de la
distancia del hueco a su lugar final. Cada movimiento invierte las dos a la vez,
así que su combinación nunca cambia.
...
\ej construir una permutación donde el resultado nunca pueda dar 1, sin
importar los signos que se elijan: todos los términos quedan pares.

...
\regex{\textbackslash W} & Ni letra, ni número, ni \_ \\ \hline
...
\$ & Final (o antes de un \texttt{\textbackslash n} final) \\ \hline
\end{tabular}
\end{center}
...
\texttt{\textbackslash d+} & Secuencias de dígitos \\ \hline
...
Extraer las secuencias de dígitos. Ojo: de \texttt{-5} toma el \texttt{5}; para enteros con signo, \texttt{-?\textbackslash d+}.
...
Así la expresión se compila una sola vez de forma explícita. El módulo \texttt{re} ya guarda en caché las expresiones usadas, así que solo se ahorra la búsqueda en esa caché.

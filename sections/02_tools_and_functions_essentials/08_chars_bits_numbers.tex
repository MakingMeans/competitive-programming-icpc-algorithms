...
\bigO{1}. Y desde Python 3.11, convertir entre entero y texto un número de más de
4300 dígitos lanza \texttt{ValueError}, tanto al imprimirlo como al leerlo con
\texttt{int()}:

\begin{lstlisting}[language=Python]
import sys, math
if hasattr(sys, "set_int_max_str_digits"):   # solo existe desde 3.11
...
anteriores a 3.11 no hay límite y la función no existe.

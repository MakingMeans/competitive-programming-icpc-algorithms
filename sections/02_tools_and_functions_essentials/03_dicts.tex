...
\bigO{1}, aunque en el peor caso pueden degradarse a \bigO{n} si existen muchas colisiones.
...
Otra forma de crear una copia sin modificar el original.

\begin{lstlisting}[language=Python]
nuevo = dict(freq)
\end{lstlisting}

Ambas copias son superficiales: si los valores son listas, la copia comparte esas
listas con el original.

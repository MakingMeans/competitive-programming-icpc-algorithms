...
\graybold{¿Para qué sirve?} Generalizar el Fenwick Tree (visto para sumas) a CUALQUIER operación invertible para mantener el valor de Grundy combinado de un rango de pilas de Nim, con actualizaciones puntuales en tiempo logarítmico. Combinado con el teorema de Sprague-Grundy/Bouton, responde instantáneamente quién gana un juego de Nim sobre cualquier subrango.

...
\graybold{I/O:} N,Q ≤ \ten{6} → lectura total con tokenización (patrón 2), y las funciones de update/query del Fenwick se escriben SIN llamadas a función (inline) para reducir el overhead de Python en este volumen de operaciones. Aun así, en el peor caso (N=Q=\ten{6}) la solución pura en Python ronda \aprox{}7s; si el juez es estricto con el límite de tiempo, este es el techo práctico de Python puro para este volumen y solo queda cambiar de lenguaje.

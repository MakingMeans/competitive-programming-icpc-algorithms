...
\graybold{I/O:} N ≤ \ten{6} → un solo recorrido lineal con lectura total (patrón 2); no hace falta tokenizar por espacios ya que la secuencia es un único string contiguo. Verificado: \aprox{}0.1s en el peor caso.

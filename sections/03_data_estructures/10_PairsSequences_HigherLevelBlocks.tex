\subsection{Balance de Paréntesis por Bloques de Nivel Superior (parejas incompatibles)}
\label{alg:3-10}
...
\graybold{I/O:} N ≤ \ten{6} → lectura total + tokenización (patrón 2): el primer token es N y el segundo, la secuencia entera como un único string; luego basta un solo recorrido lineal. Verificado: \aprox{}0.1s en el peor caso.

\subsection{Simulación XOR con Detección de Ciclos (interruptores y bombillas)}
\label{alg:7-5}
...
\graybold{I/O:} N,M ≤ 1000 → readline por línea (patrón 1) es más que suficiente, dado que el propio algoritmo termina en a lo más \aprox{}2N iteraciones (verificado: <0.03s incluso en el peor caso N=M=1000).

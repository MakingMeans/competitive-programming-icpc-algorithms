...
\graybold{Fundamento teórico:} Como $1/x$ es el mayor de los tres sumandos o al menos uno de ellos lo es, se puede suponer $1/x \ge \frac{1}{3}\cdot\frac{4}{n}$, y como además $1/x \le 4/n$ (la igualdad es el caso $p = 0$ de más abajo), el primer denominador cumple $\lceil n/4 \rceil \le x \le \lfloor 3n/4 \rfloor$. Ese rango tiene unos $n/2$ valores, pero no hace falta recorrerlo entero: el código prueba solo los primeros 300 y, en todo el rango de $n$ del problema, siempre encuentra solución entre los 6 primeros. Fijado $x$, queda $\frac{p}{q} = \frac4n - \frac1x$ con $p = 4x - n$ y $q = nx$, y se reduce la fracción. Ahí aparecen tres atajos que explotan que los denominadores pueden repetirse: si $p = 0$, ya se tiene $4/n = 1/x$ y basta partirlo con $\frac1x = \frac{1}{2x} + \frac{1}{4x} + \frac{1}{4x}$; si $p = 1$, el resto $1/q$ se parte en $\frac{1}{2q} + \frac{1}{2q}$; y si $p = 2$, el resto $2/q$ es directamente $\frac1q + \frac1q$. Solo cuando $p \ge 3$ hace falta buscar: se necesita $\frac{p}{q} = \frac1y + \frac1z$, y como $1/y < p/q$ obliga a $y > q/p$, mientras que $1/y \ge \frac12 \cdot \frac{p}{q}$ obliga a $y \le 2q/p$, el candidato $y$ vive en un rango acotado; para cada uno, $\frac1z = \frac{p}{q} - \frac1y = \frac{py - q}{qy}$, así que sirve exactamente cuando $py - q$ divide a $qy$. Empíricamente el primer $y$ útil aparece muy pronto, por eso alcanza con explorar unos cientos de candidatos por cada $x$. Vale notar qué tan chico es el caso realmente difícil: solo necesitan la búsqueda los $n$ que cumplen $n \equiv 1$ o $5 \pmod{12}$ (1666 de los 9998 del rango), entre los que están los casos más duros de la conjetura ($n \equiv 1 \pmod{24}$), y para todos ellos la búsqueda encontró solución.

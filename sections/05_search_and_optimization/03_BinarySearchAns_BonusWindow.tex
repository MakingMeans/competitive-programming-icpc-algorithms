...
\graybold{I/O:} N ≤ \ten{5} → lectura total con tokenización (patrón 2). Verificado contra fuerza bruta en 300 casos aleatorios pequeños con alturas de al menos 1. Ojo: la búsqueda binaria arranca en 1, así que el código supone alturas positivas; si el enunciado admitiera alturas 0, nunca respondería 0.

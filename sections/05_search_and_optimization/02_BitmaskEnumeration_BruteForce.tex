\subsection{Enumeración por Máscaras de Bits (Bitmask Brute Force)}
...
\graybold{Complejidad:} O(2\textasciicircum{}k · costo de evaluar una combinación), con k = número de incógnitas binarias.
...
\graybold{I/O:} |M'| ≤ 500 pero el total de '*' (en M' y N' combinados) es ≤ 16 → lectura total con readline es más que suficiente; el costo real está en las 2\textasciicircum{}16 combinaciones, no en la entrada.

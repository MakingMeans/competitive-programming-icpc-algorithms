...
\graybold{I/O:} |M'| ≤ 500 pero el total de '*' (en M' y N' combinados) es ≤ 16 → leer las dos líneas con readline (patrón 1) es más que suficiente; el costo real está en las \pow{2}{16} combinaciones, no en la entrada.

\subsection{Distribución de Días de Espera (Stars and Bars)}
...
Contar el número de formas de distribuir una cantidad fija de elementos indistinguibles entre varios grupos independientes. Es una de las aplicaciones más comunes de la técnica de \textit{Stars and Bars} (estrellas y barras), utilizada frecuentemente en problemas de combinatoria, programación competitiva y teoría de conteo.

\graybold{Complejidad:}

Preprocesamiento de factoriales: \bigO{MAX}.

Cada consulta: \bigO{1}.
...
Se conocen las posiciones de todos los oasis de una ruta.

Para cada consulta se recibe un oasis destino y el número exacto de días que debe durar el viaje.

Calcular cuántos planes distintos existen para distribuir los días de espera manteniendo siempre el mismo recorrido.
...
Las distancias a los oasis no superan los 60 días, por lo que todos los factoriales necesarios pueden precomputarse una única vez antes de responder las consultas.

Cada consulta se responde en tiempo constante.

...
%
%  TEXTO
%   - Título: Técnica (variante o problema corto). Sin matemática: va al índice
%     y a los marcadores del PDF.
%   - Etiquetas de cada entrada, SIEMPRE en este orden y en la misma línea que
%     su texto (salvo las dos que encabezan un bloque):
%       Preguntas guía:  Utilidad:  Complejidad:  Fundamento teórico:
%       Ejercicio aplicado   I/O:   Código solución
%   - Bloque opcional tras el código, para variantes que no son la solución:
